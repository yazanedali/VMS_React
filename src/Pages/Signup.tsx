  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0F172A]">
      <div className="bg-[#1E293B] p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-center text-2xl font-bold text-[#E2E8F0] mb-6">
          Sign Up
        </h2>
        <form onSubmit={submitForm}>
          <label htmlFor="full-name" className="block mb-2 text-sm text-white">
            Full Name
          </label>
          <input
            type="text"
        ...
        <p className="text-center text-sm text-[#94A3B8] mt-4">
          ...
          <a
            className="text-[#3B82F6] hover:underline hover:cursor-pointer"
            onClick={() => navigate("/")}
          >
            Login
          </a>
